    ...
    describe("[Buy now] User fulfills a sell order for a single ERC721", async () => {
      ...
      it("ERC721 <=> ETH (basic)", async () => {
        ...
        const basicOrderParameters = getBasicOrderParameters(
          0, // BasicOrderRouteType.ETH_TO_ERC721
          order
        );

        console.log('order', JSON.stringify(basicOrderParameters, null, 2));
        console.log('orderHash', orderHash);
        console.log('value', value);
      ...
      it("ERC721 <=> ETH (basic, minimal and verified on-chain)", async () => {
        ...
        const consideration = [getItemETH(parseEther("1"), parseEther("1"), seller.address)];
      ...
      it("ERC721 <=> ETH (basic, EIP-2098 signature)", async () => {
        ...
        console.log('order', basicOrderParameters);
      ...
      it("ERC721 <=> ERC20 (standard)", async () => {
        ...
        const consideration = [
          ...
          getTestItem20(parseEther("50"), parseEther("50"), zone.address),
          getTestItem20(parseEther("50"), parseEther("50"), owner.address),
        ];
        ...
        console.log('order', order);
        console.log('buyer erc20 balance before', formatEther(await testERC20.balanceOf(buyer.address)));
        ...
        console.log('buyer erc20 balance end', formatEther(await testERC20.balanceOf(buyer.address)));
      });
